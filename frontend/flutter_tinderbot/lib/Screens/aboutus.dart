        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: const [
              ...
              SizedBox(height: 10),
              Text(
                "We are a group of students who are attempting to use Machine Learning to find better matches for "
    ...
    return Container(
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: NetworkImage(
              'https://images.unsplash.com/photo-1509114397022-ed747cca3f65?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NDF8fGxvdmV8ZW58MHx8MHx8&auto=format&fit=crop&w=900&q=60'), // <-- BACKGROUND IMAGE
          fit: BoxFit.cover,
        ),
      ),
    );
