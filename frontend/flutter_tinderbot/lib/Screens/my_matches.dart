...
import 'package:flutter_tinderbot/Screens/edit_pref.dart';
import 'package:flutter_tinderbot/Screens/homepage.dart';
import 'package:flutter_tinderbot/Screens/loginpage.dart';
import 'package:flutter_tinderbot/Screens/prev_matches.dart';
  ...
  List<Container> cards = [
    Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: NetworkImage(
              'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8cGVvcGxlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=900&q=60'), // <-- BACKGROUND IMAGE
          fit: BoxFit.contain,
        ),
      ),
    ),
    Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: NetworkImage(
              'https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8cGVvcGxlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=900&q=60'), // <-- BACKGROUND IMAGE
          fit: BoxFit.contain,
        ),
      ),
    ),
    Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: NetworkImage(
              'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTd8fHBlb3BsZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=900&q=60'), // <-- BACKGROUND IMAGE
          fit: BoxFit.contain,
        ),
      ),
    )
                  ...
                  TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const PrevPreferences()),
                        );
                      },
                      style: TextButton.styleFrom(
                          //backgroundColor: const Color.fromRGBO(146, 98, 74, 89),
