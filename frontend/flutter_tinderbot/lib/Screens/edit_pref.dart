                                        ...
                                        TextFormField(
                                          decoration: const InputDecoration(
                                              ...
                                              focusColor: Color.fromRGBO(
                                                  253, 241, 236, 10),
                                              hintText:
                                                  'Input your desired age range here'),
                                        )
                                      ],
                                    ),
                                  ),
    ...
    return Container(
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: NetworkImage(
              'https://images.unsplash.com/photo-1535615615570-3b839f4359be?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8bG92ZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=900&q=60'), // <-- BACKGROUND IMAGE
          fit: BoxFit.cover,
        ),
      ),
    );
