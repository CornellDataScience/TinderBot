                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          const Text("Edit preferences menu manually", style: TextStyle(
                            color: Colors.black,
                            fontSize: 30,
                          )),
                          TextButton(
                              ...
                              }, child: Text("Edit preferences menu manually", style: Theme.of(context).textTheme.bodyMedium,)
                          ),
                        ],
                      ),
                    ),
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          const Text("Previous Matches!", style: TextStyle(
                            color: Colors.black,
                            fontSize: 30,
                          )),
                          TextButton(
