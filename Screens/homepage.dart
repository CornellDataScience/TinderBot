                  ...
                  child: Padding(
                    ...
                    children: [
                      ...
                      TextButton(
                          ...
                          }, child: Text("Click to start", style: Theme.of(context).textTheme.bodyMedium,)
                      ),
                    ],
                ),
                  ),
    ...
    return Container(
       ...
       decoration: const BoxDecoration(
         image: DecorationImage(
           image: NetworkImage('https://images.unsplash.com/photo-1517867065801-e20f409696b0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Njl8fGxvdmV8ZW58MHx8MHx8&auto=format&fit=crop&w=900&q=60'), // <-- BACKGROUND IMAGE
           fit: BoxFit.cover,
         ),
